...
package dev.kobalt.msgboxgen.web.source
...
object SourceRepository {
    ...
    fun selectList(): List<Triple<String, String, String>> = listOf(
        Triple("dev.kobalt.msgboxgen.jvm", "Application", "Executable JAR that is used to generate message boxes."),
        Triple(
            "dev.kobalt.msgboxgen.web",
            "Frontend",
            "Website server that uses executable JAR for generating message boxes."
        )
    )
